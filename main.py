...
import cv2 # para captura em tempo real,futuramente
import math
import cvzone # para colocar a caixa de texto com o fundo
...
while True:
    ...
    for i in results:
        ...
        for box in boxes:
            ...
            print(conf)
            cls = int(box.cls[0])
            cvzone.putTextRect(imagem, f"{cls} {conf}",(max(0, x1),max(20, y1)))
